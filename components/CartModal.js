...
// FITUR BUKA-TUTUP (isOpen) SUDAH DITAMBAHKAN KEMBALI DI SINI
export default function CartModal({ isOpen, cart, onClose, onRemove, onCheckout }) {
  const [isCheckingOut, setIsCheckingOut] = useState(false)

  // Hitung total harga (dengan pengaman kalau cart belum terisi)
  ...
  return (
    <AnimatePresence>
      {/* PINTU GERBANGNYA ADA DI SINI. Kalau isOpen bernilai false, dia sembunyi */}
      {isOpen && (
