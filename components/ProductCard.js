export default function ProductCard({ product, onAdd }) {
  ...
  return (
    <article className="liquid-card group relative h-full overflow-hidden rounded-[2rem] p-4 transition duration-500 hover:-translate-y-2 hover:border-cyan-200/35 hover:shadow-[0_30px_90px_rgba(8,145,178,0.24)]">
      <div className="absolute -right-16 -top-16 h-36 w-36 rounded-full bg-cyan-300/20 blur-3xl transition duration-500 group-hover:bg-cyan-300/35" />
      <div className="relative overflow-hidden rounded-[1.5rem] border border-white/15 bg-slate-950/40 shadow-inner">
        <img
          ...
          className="h-48 w-full object-cover opacity-90 saturate-125 transition duration-700 group-hover:scale-105"
        />
      ...
      <div className="relative mt-5 flex h-[calc(100%-14rem)] flex-col">
        ...
        <div className="mt-auto pt-5">
          ...
          <button
            onClick={onAdd}
            className="w-full rounded-2xl bg-gradient-to-r from-cyan-300 via-sky-300 to-violet-300 px-4 py-3 text-sm font-black text-slate-950 shadow-[0_18px_45px_rgba(56,189,248,0.22)] transition duration-300 hover:scale-[1.02] hover:shadow-[0_24px_60px_rgba(56,189,248,0.34)]"
          >
            + Tambah ke Keranjang
          </button>
        </div>
